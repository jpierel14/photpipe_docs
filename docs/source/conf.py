...
sys.path.insert(0, os.path.abspath('../../Photpipe'))


# -- Project information -----------------------------------------------------

project = 'Photpipe'
copyright = '2021, Armin Rest'
author = 'Armin Rest'
...
sphinx_gallery_conf = {
    ...
    'doc_module': ('Photpipe',),  # documented module(s)
...
latex_documents = [
    (master_doc, 'Photpipe.tex', 'Photpipe Documentation',
     'Armin Rest', 'manual'),
]
...
man_pages = [
    (master_doc, 'Photpipe', 'Photpipe Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'Photpipe', 'Photpipe Documentation',
     author, 'Photpipe', 'One line description of project.',
     'Miscellaneous'),
]
